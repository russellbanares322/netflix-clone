            ...
            <div className={styles.gradient}></div>
                ...
                <div className={styles.movie_wrapper}>
                    <div className={styles.left}>
                        ...
                        <span className={styles.movie_status}>STATUS: <span style={{color: movieDetails?.status === 'Released' ? 'green' : 'red', fontWeight:'600'}}>{movieDetails?.status}</span></span>
                        ...
                        {movieDetails?.homepage !== null ? <span className={styles.movie_link}>HOMEPAGE: <a target="_blank"  href={movieDetails?.homepage}>{movieDetails?.homepage}</a></span> : ''}
                    </div>
                    <div className={styles.right}>
                        <img className={styles.movie_img} src={`https://image.tmdb.org/t/p/original/${movieDetails.poster_path}`}/>
